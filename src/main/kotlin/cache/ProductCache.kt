...
class ProductCache {
    ...
    suspend fun clear(id: Int? = null) {
        if (id != null) {
            ...
            // Упрощенно - очищаем только конкретный ключ, если передан
            // Для полной очистки в проде нужен SCAN, но пока оставим так
            // или можно не реализовывать массовую очистку
        }
    }
}